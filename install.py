...
def install_package():
    ...
    conda_import_path = common_suffix + '/deploy/prerequisites.txt'
    conda_import_fallback_path = common_suffix + '/deploy/prerequisites.fallback.txt'
    conda_install = 'conda install --file %s' % conda_import_path
    conda_install_fallback = 'conda install --file %s' % conda_import_fallback_path
    if os.system(conda_install):
        print('')
        print('=======================================================')
        ...
        if os.system(conda_install_fallback):
            print('')
            print('=======================================================')
            print('|Fetal error occurred when installing python packages |')
